...
SECRET_KEY = "django-insecure-b2rc0y=0ejnf7hy4qd+7-(i^adcyaga2vr44$ma8irn#9&g#wr"
...
CACHES = {
    "default": {
        ...
        "LOCATION": "redis://localhost:6380/1",  # Use 'redis://redis:6379/1' when running in Docker
        "OPTIONS": {
